...
// GetUsersStatsReviewedPRsParams defines parameters for GetUsersStatsReviewedPRs.
type GetUsersStatsReviewedPRsParams struct {
	// Cursor Курсор для пагинации, возвращается предыдущим запросом
