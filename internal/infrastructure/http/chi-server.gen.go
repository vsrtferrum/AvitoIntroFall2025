...
type ServerInterface interface {
	...
	// Получить статистику всех пользователей по проверенным PR с курсорной пагинацией
	// (GET /users/statsReviewedPRs)
	GetUsersStatsReviewedPRs(w http.ResponseWriter, r *http.Request, params GetUsersStatsReviewedPRsParams)
}
...
// Получить статистику всех пользователей по проверенным PR с курсорной пагинацией
// (GET /users/statsReviewedPRs)
func (_ Unimplemented) GetUsersStatsReviewedPRs(w http.ResponseWriter, r *http.Request, params GetUsersStatsReviewedPRsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetUsersStatsReviewedPRs operation middleware
func (siw *ServerInterfaceWrapper) GetUsersStatsReviewedPRs(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetUsersStatsReviewedPRsParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetUsersStatsReviewedPRs(w, r, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/users/statsReviewedPRs", wrapper.GetUsersStatsReviewedPRs)
	})
